...
Please note that thresholds mentioned on the paper in Figure 5a, and Methods section had a typo The correct thresholds are following  : Mismatch frequency : 0.137, C frequency : 0.578. All computations in the paper were done with the correct thresholds. 


![alt text](./img/c_to_u_signature.png "c_to_u_signature")


![alt text](./img/pseudoU_detection.png "pseudoU_detection")
